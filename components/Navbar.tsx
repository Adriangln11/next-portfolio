  ...
  return (
    <div className='w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4'>
      <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between '>
        {/* ============ Logo Start here ============ */}
        <Link href='https://github.com/Adriangln11' target='_blank'>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                className='text-sm w-72 tracking-widest text-textLight hover:text-hoverColor text-center mt-4 transition-colors duration-300'
                href='mailto:cesarqqu@gmail.com'
              >
                <p>cesarqqu@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
