      ...
      <div className='w-full flex flex-col items-center justify-center gap-28 mt-10'>
        <div className='flex flex-col xl:flex-row gap-6'>
          ...
          >
            <div>
              ...
              />
              <div className='absolute w-full h-full bg-[#DDDDDD]/50 rounded-lg top-0 left-0 group-hover:bg-transparent duration-300'></div>
            </div>
          </a>
          <div className='w-full xl:w-1/2 flex flex-col gap-6 lgl:justify-between items-end text-right xl:-ml-16 z-10'>
            ...
            <p className='bg-[#EEEEEE] text-sm md:text-base p-2 md:p-6 rounded-md'>
        ...
        <div className='flex flex-col xl:flex-row-reverse gap-6'>
          ...
          <div className='w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10'>
            ...
            <p className='text-sm md:text-base bg-[#EEEEEE] p-2 md:p-6 rounded-md xl:-mr-16'>
        ...
        <div className='flex flex-col xl:flex-row gap-6'>
          ...
          <div className='w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10'>
            ...
            <p className='text-sm md:text-base bg-[#EEEEEE] p-2 md:p-6 rounded-md'>
